...
canvas.height = innerHeight; // canvas.width = 1024;
// canvas.height = 576;
...
var platformImage = createImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
var init = function init() {
  player = new Player();
  platformImage = createImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
  platformSmallTallImage = createImage(_img_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_4__["default"]);
  platforms = [new Platform({
    x: platformImage.width * 5 + 298 - platformSmallTallImage.width,
    y: 350,
...
var animate = function animate() {
  ...
  if (scrollOffset > platformImage.width * 5 + 298) console.log('win'); // Game Over
